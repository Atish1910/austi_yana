...
$EmailcheckQuery = "SELECT * FROM `ay_table` WHERE email='$email'";
$PhonecheckQuery = "SELECT * FROM `ay_table` WHERE phone='$phone'";
...
if (mysqli_num_rows($checkEmail) > 0) {
    ...
    $query12 = "INSERT INTO `ay_table`(fname, email, phone, msg , utm_source, utm_medium, utm_campaign, utm_term, utm_content) 
